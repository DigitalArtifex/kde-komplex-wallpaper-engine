...
ShaderToySearchModel::ShaderToySearchModel(QObject *parent)
    : QAbstractItemModel{parent}
{
    m_networkManager.setAutoDeleteReplies(true);
}

QVariant ShaderToySearchModel::data(const QModelIndex &index, int role) const
{
...
QHash<int, QByteArray> ShaderToySearchModel::roleNames() const
{
    return m_dataRoles;
}

void ShaderToySearchModel::downloadMedia(QString fileLocation, QString fileUrl)
{
    QUrl remoteUrl(QStringLiteral("http://www.shadertoy.com%2").arg(fileUrl));
...
void ShaderToySearchModel::compile(quint64 index)
{
...
void ShaderToySearchModel::save(quint64 index)
{
    ShaderToyEntry entry = m_data[index];
...
void ShaderToySearchModel::install(quint64 index)
{
    ShaderToyEntry entry = m_data[index];
...
void ShaderToySearchModel::download(quint64 index)
{
    ShaderToyEntry entry = m_data[index];
...
void ShaderToySearchModel::resetModel()
{
    beginResetModel();
    m_data.clear();
    endResetModel();
...
ShaderToySearchModel::Status ShaderToySearchModel::status() const
{
    return m_status;
}

void ShaderToySearchModel::setStatus(const Status &status, const QString &message)
{
...
QModelIndex ShaderToySearchModel::index(int row, int column, const QModelIndex &parent) const
{
    Q_UNUSED(parent)
    return createIndex(row, column, &m_data.at(row));
}

int ShaderToySearchModel::columnCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent)
    return 0;
}

QModelIndex ShaderToySearchModel::parent(const QModelIndex &index) const
{
    Q_UNUSED(index)
    return QModelIndex();
}

bool ShaderToySearchModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    if(index.row() < 0 || index.row() >= m_data.count())
        return false;
...
QString ShaderToySearchModel::lastSavedFile() const
{
    return m_lastSavedFile;
}

void ShaderToySearchModel::setLastSavedFile(const QString &lastSavedFile)
{
...
QStringList ShaderToySearchModel::videoSelections() const
{
    return m_videoSelections;
}

void ShaderToySearchModel::setVideoSelections(const QStringList &videoSelections)
{
...
QString ShaderToySearchModel::statusMessage() const
{
    return m_statusMessage;
}

void ShaderToySearchModel::setStatusMessage(const QString &statusMessage)
{
...
QString ShaderToySearchModel::downloadText() const
{
    return m_downloadText;
}

void ShaderToySearchModel::setDownloadText(const QString &downloadText)
{
...
quint64 ShaderToySearchModel::completedDownloads() const
{
    return m_completedDownloads;
}

void ShaderToySearchModel::setCompletedDownloads(quint64 completedDownloads)
{
...
quint64 ShaderToySearchModel::totalDownloads() const
{
    return m_totalDownloads;
}

void ShaderToySearchModel::setTotalDownloads(quint64 totalDownloads)
{
...
QString ShaderToySearchModel::compilerErrorOutput() const
{
    return m_compilerErrorOutput;
}

void ShaderToySearchModel::setCompilerErrorOutput(const QString &compilerErrorOutput)
{
...
QString ShaderToySearchModel::compilerOutput() const
{
    return m_compilerOutput;
}

void ShaderToySearchModel::setCompilerOutput(const QString &compilerOutput)
{
...
quint64 ShaderToySearchModel::totalPages() const
{
    return m_totalPages;
}

void ShaderToySearchModel::setTotalPages(quint64 totalPages)
{
...
void ShaderToySearchModel::next()
{
...
void ShaderToySearchModel::previous()
{
    if(m_currentPage <= 0)
        return;
...
void ShaderToySearchModel::convert(qsizetype index)
{
...
ShaderToyEntry ShaderToySearchModel::entry(qsizetype index)
{
    if(index < 0 || index >= m_data.count())
...
void ShaderToySearchModel::finalize(qsizetype index)
{
...
void ShaderToySearchModel::replaceSource(qsizetype index, QString uuid, QString source)
{
...
quint64 ShaderToySearchModel::currentPage() const
{
    return m_currentPage;
}

void ShaderToySearchModel::setCurrentPage(quint64 currentPage)
{
...
quint64 ShaderToySearchModel::resultsPerPage() const
{
    return m_resultsPerPage;
}

void ShaderToySearchModel::setResultsPerPage(quint64 resultsPerPage)
{
...
QString ShaderToySearchModel::query() const
{
    return m_query;
}

void ShaderToySearchModel::setQuery(const QString &query)
{
    m_query = query;
    Q_EMIT queryChanged();
...
void ShaderToySearchModel::getSearchResults(QString url)
{
    ...
    (
        ...
        [this, reply]()
        {
            ...
            setTotalResults(rootObject[QStringLiteral("Shaders")].toInt());
...
quint64 ShaderToySearchModel::totalResults() const
{
    return m_totalResults;
}

void ShaderToySearchModel::setTotalResults(quint64 totalResults)
{
...
int ShaderToySearchModel::rowCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent)
    return m_data.size();
}
